					...
					>
						...
						<div v-else class="flex flex-col">
							<div>
								...
								<div
									class="invisible absolute -bottom-4 -right-6 flex cursor-pointer opacity-75 duration-300 ease-in hover:opacity-100 group-hover:visible"
								>
									<span
