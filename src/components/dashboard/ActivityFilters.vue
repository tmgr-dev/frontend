	...
	<div class="activity-filters flex items-center space-x-2">
		...
		<Popover>
			<PopoverTrigger as-child>
				<button
					type="button"
					class="flex h-10 w-32 items-center justify-between rounded-md border border-input bg-background px-3 py-2 text-start text-sm ring-offset-background focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2"
				>
