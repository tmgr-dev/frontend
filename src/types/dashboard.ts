...
export interface FilteredRequestParams<TFilter = any, TSort = SortOption>
...
export interface DashboardStatisticsResponse
	extends ApiResponse<DashboardStatistics> {}

export interface ActivityFeedResponse
	extends ApiResponse<PaginatedResponse<Activity>> {}
...
export const isValidationErrorResponse = (
	...
	return (
		isApiErrorResponse(obj) && obj.errors && typeof obj.errors === 'object'
	);
};

export const isNetworkErrorResponse = (
	obj: any,
): obj is NetworkErrorResponse => {
	return (
		obj &&
...
export const isLoadingState = (obj: any): obj is LoadingState => {
	return obj && typeof obj.isLoading === 'boolean';
};

export const isDetailedLoadingState = (
	obj: any,
): obj is DetailedLoadingState => {
	return (
		obj &&
...
export const isActionResult = <T>(obj: any): obj is ActionResult<T> => {
	return (
		obj && typeof obj.success === 'boolean' && typeof obj.timestamp === 'string'
	);
};
...
export type ApiResponseData<T extends ApiResponse<any>> = T extends ApiResponse<
	infer U
>
	? U
	: never;
export type PaginatedData<T extends PaginatedResponse<any>> =
